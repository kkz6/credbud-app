...
//        } else {
//            description.cloudKitContainerOptions = NSPersistentCloudKitContainerOptions(containerIdentifier: "iCloud.com.gigcodes.credbud")
//        }

        description.cloudKitContainerOptions = NSPersistentCloudKitContainerOptions(containerIdentifier: "iCloud.com.gigcodes.credbud")

        let groupID = "group.com.gigcodes.credbud"
...
////        }
    ...
    var addedTransaction: Bool {
        get {
            UserDefaults(suiteName: "group.com.gigcodes.credbud")!.bool(forKey: "newTransactionAdded")
        }

        set {
            UserDefaults(suiteName: "group.com.gigcodes.credbud")!.set(newValue, forKey: "newTransactionAdded")
        }
    }
    ...
    func fetchRequestForLogView(type: Int, optionalIncome: Bool?, categoryFilters: [Category] = []) -> NSFetchRequest<Transaction> {
        ...
        if type == 5 {
            ...
            if type == 1 {
                ...
                let startOfMonth = UserDefaults(suiteName: "group.com.gigcodes.credbud")!.integer(forKey: "firstDayOfMonth")
