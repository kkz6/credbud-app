...
//  xpenz
//
//  Created by Karthick K on 19/5/22.
//
...
struct LogView: View {
    ...
    @AppStorage("showCents", store: UserDefaults(suiteName: "group.com.gigcodes.credbud")) var showCents: Bool = true
    ...
    @AppStorage("logTimeFrame", store: UserDefaults(suiteName: "group.com.gigcodes.credbud")) var logTimeFrame = 2
...
struct LogInsightsView: View {
    ...
    @AppStorage("logInsightsTimeFrame", store: UserDefaults(suiteName: "group.com.gigcodes.credbud")) var timeframe = 2
    @AppStorage("logInsightsType", store: UserDefaults(suiteName: "group.com.gigcodes.credbud")) var insightsType = 1

    @AppStorage("logViewLineGraph", store: UserDefaults(suiteName: "group.com.gigcodes.credbud")) var lineGraph: Bool = false
    ...
    var range: Int {
        ...
        calendar.firstWeekday = UserDefaults(suiteName: "group.com.gigcodes.credbud")?.integer(forKey: "firstWeekday") ?? 0
...
struct TransactionsList: View {
    ...
    @AppStorage("showUpcomingTransactions", store: UserDefaults(suiteName: "group.com.gigcodes.credbud")) var showUpcoming: Bool = true
    @AppStorage("showUpcomingTransactionsWhenUpcoming", store: UserDefaults(suiteName: "group.com.gigcodes.credbud")) var showSoon: Bool = false
...
struct ListView: View {
    ...
    @AppStorage("swapTimeLabel", store: UserDefaults(suiteName: "group.com.gigcodes.credbud")) var swapTimeLabel: Bool = false
...
struct DeleteTransactionAlert: View {
    ...
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.gigcodes.credbud")) var bottomEdge: Double = 15
